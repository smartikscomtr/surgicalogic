        ...
        <v-card-text>
          <v-container grid-list-md>
            <v-layout wrap>
              ...
              <v-flex xs12 sm6 md6>
                <v-text-field v-model="editAction['firstName']" :label="$t('personnel.givenName')">
                </v-text-field>
              </v-flex>

              <v-flex xs12 sm6 md6>
                <v-text-field v-model="editAction['lastName']" :label="$t('personnel.familyName')">
                </v-text-field>
              </v-flex>

              <v-flex xs12 sm6 md6>
                <v-select v-model="selectPersonnelTitle" :items="personnelTitles" :label="$t('personneltitle.personnelTitle')" item-text="name" item-value="id">
                </v-select>
              </v-flex>

              <v-flex xs12 sm6 md6>
                <v-select v-model="selectBranch" :items="branchs" :label="$t('branchs.branch')" item-text="name" item-value="id">
                </v-select>
              </v-flex>

              <v-flex xs12 sm6 md6>
                <v-select v-model="selectWorkType" :items="workTypes" :label="$t('worktypes.workType')" item-text="name" item-value="id">
                </v-select>
              </v-flex>

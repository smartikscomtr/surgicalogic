        ...
        <v-card-text>
          <v-layout wrap edit-layout>
            <v-flex xs12 sm12 md12>
              <v-text-field v-model="editAction['name']" :label="$t('branches.branchName')">
              </v-text-field>
            </v-flex>
    ...
    computed: {
        formTitle() {
            ...
            return vm.editIndex === -1
                ? vm.$i18n.t('branches.addBranchesInformation')
                : vm.$i18n.t('branches.editBranchesInformation');
        },

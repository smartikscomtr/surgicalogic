...
namespace Surgicalogic.Test
{
    ...
    public class ORToolsTest
    {
        ...
        public void ConsecutiveOperationsTest()
        {
            ...
            var tomorrow = DateTime.Now.AddDays(1);
            var operations = new List<Operation>();
            operations.Add(new Operation { Id = 2, StartDate = new DateTime(tomorrow.Year, tomorrow.Month, tomorrow.Day, 09, 0, 0) });
            operations.Add(new Operation { Id = 4, StartDate = new DateTime(tomorrow.Year, tomorrow.Month, tomorrow.Day, 9, 15, 0) });
            operations.Add(new Operation { Id = 6, StartDate = new DateTime(tomorrow.Year, tomorrow.Month, tomorrow.Day, 09, 45, 0) });
            operations.Add(new Operation { Id = 7, StartDate = new DateTime(tomorrow.Year, tomorrow.Month, tomorrow.Day, 10, 00, 0) });
            expected.Rooms.Add(new Room { Id = 1, Operations = operations });
            operations = new List<Operation>();
        ...
        public void SecondChangedPeriod()
        {
            ...
            var tomorrow = DateTime.Now.AddDays(1);
            var operations = new List<Operation>();
            operations.Add(new Operation { Id = 3, StartDate = new DateTime(tomorrow.Year, tomorrow.Month, tomorrow.Day, 15, 15, 0) });
            expected.Rooms.Add(new Room { Id = 1, Operations = operations });
            operations = new List<Operation>();
